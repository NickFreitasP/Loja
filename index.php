...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="./vategorias.php">Categorias</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <a target="_blank" title="Ir para o linkedin" href="https://www.linkedin.com/in/nicholas-freitas-4290ba228/"><i class="fa fa-linkedin text-info"></i></a>
                            <a target="_blank" title="Ir para página do instagram"  href="https://www.instagram.com/nicholas.panonko?igsh=aXYxempzbGlkNHVt"><i class="text-danger fa fa-instagram"></i></a>
                ...
                <div class="col-lg-9">
                    ...
                    <div   class="hero__item set-bg" data-setbg="img/hero/banner2.jpg">
                        <div class="hero__text">
                            ...
                            <h2> Calça Jeans </h2>
                            <h3 class="text-danger"> 30 % Off</h3>
                            <p class="mt-3 text- text-center"> Confira nossos Preços  imperdíveis </p>
                            <a href="promocao_produtos.php" class="   primary-btn  ">Comprar Agora!</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-1.jpg">
                            <h5><a href="bolsas.php">Bolsas</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-2.jpg">
                            <h5><a href="relogios.php">Relógios</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-3.jpg">
                            <h5><a href="camisas.php">Camisas</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-4.jpg">
                            <h5><a href="botas.php">Botas</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-5.jpg">
                            <h5><a href="#">Camisetas</a></h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                    <div class="banner__pic">
                        <a href="promocao1.php"><img  src="img/banner/outono1.png" alt=""></a>
                    </div>
                </div>
                <!-- <div  class=" mb-5 col-lg-8 col-md-12 col-sm-12">
                    <div class="banner__pic">
                       <a href="promocao_presentes"> <img  src="img/banner/banner-1.png" alt="">
                    </div>
                </div> -->
            </div>
        </div>
    ...
    <!--MOBILE  Banner Begin -->
    <div    class="banner_mobile mt-5 mb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                    <div class="banner__pic">
                        <a href="promocao1.php"><img  src="img/banner/outono_mobile.png" alt=""></a>
                    </div>
                </div>
                <!-- <div  class=" mb-5 col-lg-8 col-md-12 col-sm-12">
                    <div class="banner__pic">
